...
public class PanelControl extends JPanel implements ActionListener, ChangeListener
{
	...
	public PanelControl(FrameApp frame)
	{
		...
		this.add(panelMain);
		this.setBackground(FrameApp.COUL_SECONDARY);
		panelMain    .setBackground(FrameApp.COUL_SECONDARY);

		panelOutils1F.setBackground(FrameApp.COUL_SECONDARY);
		panelOutils1 .setBackground(FrameApp.COUL_SECONDARY);

		panelSelectionF.setBackground(FrameApp.COUL_SECONDARY);
		panelSelection .setBackground(FrameApp.COUL_SECONDARY);

		panelOutils2F.setBackground(FrameApp.COUL_SECONDARY);
		panelOutils2 .setBackground(FrameApp.COUL_SECONDARY);
